...
const QAS = [
  {
    question:
      "Q1. What is a Skillturn resume builder? Why resume builder is better than resume template doc?",
    answer: (
      <>
        <p>
        ...
        <p>
          ...
          Skillturn Resume Builder saves time and prevents formatting mistakes by
  ...
  {
    question:
      "Q2. What uniquely sets Skillturn Resume builder apart from other resume builders and templates?",
    answer: (
      <>
        <p>
          Other than Skillturn Resume Builder, there are some great free resume builders out
          there, e.g. <Link href="https://rxresu.me/">Reactive Resume</Link>,{" "}
          <Link href="https://flowcv.com/">FlowCV</Link>. However, Skillturn Resume Builder
          stands out with 2 distinctive features:
        </p>{" "}
        <p>
          <span className="font-semibold">
            1. Skillturn Resume Builder is designed specifically for the  job market and
            best practices.
          </span>
          <br />
          Unlike other resume builders that target a global audience and offer
          many customization options, Skillturn Resume Builder intentionally only offers
          ...
          like references. Additionally, Skillturn Resume Builder only offers a top down
          single column resume design as opposed to two column design, because
          single column design works best for AST. <br />{" "}
        </p>
        <p>
          <span className="font-semibold">
            2. Skillturn Resume Builder is super privacy focus.
          </span>{" "}
          <br />
          While other resume builders may require email sign up and store user
          data in their databases, Skillturn Resume Builder believes that resume data should
          remain private and accessible only on user’s local machine. Therefore,
          Skillturn Resume Builder doesn’t require sign up to use the app, and all inputted
